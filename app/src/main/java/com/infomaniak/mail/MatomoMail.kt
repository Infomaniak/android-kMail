...
object MatomoMail : MatomoCore {
    ...
    // We need to invert this logical value to keep a coherent value for analytics because Messages actions
    // conditions are inverted (ex: if the condition is `message.isSpam`, then we want to unspam the Message)
