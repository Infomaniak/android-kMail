...
class LocalSettings private constructor(context: Context) : SharedValues {
    ...
    enum class AccentColor(
        ...
        private fun getThemeColorMap(isNightMode: Boolean, ctx: Context): Map<String, Color> = buildMap {
            set("AccentPrimary", if (isNightMode) LottieColor.primary80(ctx) else LottieColor.primary40(ctx))
