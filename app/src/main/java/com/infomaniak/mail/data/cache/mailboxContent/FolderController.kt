...
class FolderController @Inject constructor(
    ...
    companion object {
        ...
        suspend fun updateFolder(folderRole: FolderRole, realm: Realm, onUpdate: (MutableRealm, Folder) -> Unit) {
            realm.write { getFolder(folderRole, realm = this)?.let { onUpdate(this, it) } }
        }
