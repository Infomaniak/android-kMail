...
object ApiRepository : ApiRepositoryCore() {
    ...
    fun rescheduleSnoozedThread(snoozeAction: String, newDate: Date): List<ApiResponse<Unit>> {
        return callApi(ApiRoutes.resource(snoozeAction), PUT, mapOf("end_date" to newDate.format(FORMAT_ISO_8601_WITH_TIMEZONE_SEPARATOR)))
    }
