...
class HtmlFormatter(private val html: String) {
    ...
    companion object {
        ...
        fun Context.getEditorBodyScript(): String {
            return loadScript(R.raw.get_editor_body)
        }
        ...
        fun Context.getEditorMentionPointerEventsHandlerScript(): String {
            return loadScript(R.raw.editor_mention_pointer_events_handler)
        }
