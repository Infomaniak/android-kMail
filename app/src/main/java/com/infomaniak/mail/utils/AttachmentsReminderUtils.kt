...
object AttachmentsReminderUtils {
    private val frAttachmentsReminderRegex = listOf(
        "voir pi[eèé]ces? (?:jointes?|attach[eé]es?)",
        "fichiers? (?:joints?|attach[eé]s?)",
        "fichiers? associ[eèé]s?",
        "(?:jointes?|attach[eé]es?) [aà] cet e-mail",
        "(?:jointes?|attach[eé]es?) [aà] ce message",
        "je ((te|vous) )?(?:joins|attache)",
        "j'ai (?:joint|attach[eé])",
        "ci(-| )(?:joint|attach[eé])",
        "cf\\.?\\s*(?:p\\.?j\\.?|pi[eèé]ces? (?:jointes?|attach[eé]es?))",
        "pi[eèé]ces?(-|\\s)(?:jointes?|attach[eé]es?)",
        "fichiers? joints?",
        "voir le fichier (?:joint|attach[eé])",
        "voir les fichiers (?:joints|attach[eé]s)",
        "voir la pi[eèé]ce (?:jointe|attach[eé]e)",
        "voir les pi[eèé]ces (?:jointes|attach[eé]es)",
        "en annexe",
        "en p\\.?j\\.?",
        "trouvez ci-(?:joint|attach[eé])",
        "veuillez trouver ci-(?:joint|attach[eé])",
        "[^\\w]jointe?s?[^\\w]"
    ).joinToString("|")
