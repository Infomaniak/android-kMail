...
class Colors(val light: String, val dark: String) {
    ...
    companion object {
        val color1 = Colors("#F5F5F5", "#3E3E3E")
        val color2 = Colors("#E0E0E0", "#4C4C4C")
        val color3 = Colors("#FAFAFA", "#282828")
        val color4 = Colors("#C6AC9F", "#996452")
        val color5 = Colors("#FFFFFF", "#1A1A1A")
        val color6 = Colors("#340E00", "#996452")
        val color7 = Colors("#CCCCCC", "#818181")
        val color8 = Colors("#C4C4C4", "#7C7C7C")
        val color9 = Colors("#FFFFFF", "#EAEAEA")
        val color10 = Colors("#F8F8F8", "#E4E4E4")
