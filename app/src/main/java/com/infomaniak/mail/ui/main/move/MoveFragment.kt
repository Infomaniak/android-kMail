...
class MoveFragment : Fragment() {
    ...
    @Inject
    lateinit var moveFolderAdapter: MoveAdapter
    ...
    private val moveFoldersAdapter: MoveAdapter by lazy {
        moveFolderAdapter(
    ...
    private fun observeSearchResults() = with(moveViewModel) {
        filterResults.observe(viewLifecycleOwner) { filteredFolders ->
            if (isSearching) moveFoldersAdapter.setFolders(filteredFolders, currentFolderId)
        }
    }
