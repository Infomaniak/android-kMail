...
class NewMessageViewModel @Inject constructor(
    ...
    fun executeDraftActionWhenStopping(
        ...
        appContext.trackSendingDraftEvent(action, draftInRAM, currentMailbox.externalMailFlagEnabled)
    ...
    override fun onCleared() {
        LocalStorageUtils.deleteDraftUploadDir(appContext, draftInRAM.localUuid)
        super.onCleared()
    }
