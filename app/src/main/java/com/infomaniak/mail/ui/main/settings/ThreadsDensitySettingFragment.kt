...
import com.infomaniak.mail.databinding.FragmentThreadsDensitySettingBinding

class ThreadsDensitySettingFragment : Fragment() {

    private lateinit var binding: FragmentThreadsDensitySettingBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        return FragmentThreadsDensitySettingBinding.inflate(inflater, container, false).also { binding = it }.root
    }
