...
class IlluColors(val keyPath: KeyPath, val lightColor: String, val darkColor: String) {
    ...
    companion object {
        ...
        val illu2Colors = arrayOf(
            ...
            IlluColors(KeyPath("MOVING NOTIF 1", "Groupe 8", "Fond 1"), lightColor = "#E0E0E0", darkColor = "#4C4C4C"),
            IlluColors(KeyPath("MOVING NOTIF 1", "Groupe 9", "Fond 1"), lightColor = "#E0E0E0", darkColor = "#4C4C4C"),
            IlluColors(KeyPath("MOVING NOTIF 1", "Groupe 10", "Fond 1"), lightColor = "#E0E0E0", darkColor = "#4C4C4C"),
            ...
            IlluColors(KeyPath("MOVING NOTIF 2 TITLE", "Groupe 1", "Fond 1"), lightColor = "#E0E0E0", darkColor = "#4C4C4C"),
            IlluColors(KeyPath("MOVING NOTIF 2 PREVIEW", "Groupe 1", "Fond 1"), lightColor = "#E0E0E0", darkColor = "#4C4C4C"),
            IlluColors(KeyPath("ARCHIVES", "Groupe 1", "Fond 1"), lightColor = "#FFFFFF", darkColor = "#1A1A1A"),
            IlluColors(KeyPath("ARCHIVES", "Groupe 2", "Fond 1"), lightColor = "#FFFFFF", darkColor = "#1A1A1A"),
            IlluColors(KeyPath("ARCHIVES", "Groupe 3", "Fond 1"), lightColor = "#FFFFFF", darkColor = "#1A1A1A"),
            IlluColors(KeyPath("ARCHIVES", "Groupe 4", "Fond 1"), lightColor = "#FFFFFF", darkColor = "#1A1A1A"),
        )
