...
public class CommonConfetti {
    ...
    public static CommonConfetti rainingConfetti(ViewGroup container, int[] colors) {
        ...
        final ConfettiSource confettiSource = new ConfettiSource(0, -defaultConfettiSize, container.getWidth(), -defaultConfettiSize);
    ...
    private static void ensureStaticResources(ViewGroup container) {
        if (defaultConfettiSize == 0) {
            ...
            defaultConfettiSize = res.getDimensionPixelSize(R.dimen.confetti_size);
            defaultVelocitySlow = res.getDimensionPixelOffset(R.dimen.confetti_velocity_slow);
            defaultVelocityNormal = res.getDimensionPixelOffset(R.dimen.confetti_velocity_normal);
            defaultVelocityFast = res.getDimensionPixelOffset(R.dimen.confetti_velocity_fast);
            explosionRadius = res.getDimensionPixelOffset(R.dimen.confetti_explosion_radius);
        }
    }
