...
public class ConfettiView extends View implements View.OnLayoutChangeListener {
    ...
    public static ConfettiView newInstance(Context context) {
        ...
        confettiView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));

        final int defaultElevation = context.getResources().getDimensionPixelOffset(R.dimen.confetti_elevation);
