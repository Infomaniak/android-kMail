...
open class Recipient : EmbeddedRealmObject, Correspondent, ContactAutocompletable {
    ...
    override var cachedInitials: String? = null
    ...
    companion object : Parceler<Recipient> {
        ...
        fun createValidRecipient(
            syntacticallyValidEmail: String,
            name: String? = null,
            hasExternalProvider: Boolean? = null
        ): Recipient {
            return Recipient().initLocalValues(syntacticallyValidEmail, name, hasExternalProvider)
        }
    }
}
